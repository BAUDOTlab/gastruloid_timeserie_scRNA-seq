...
It has been shown that the pN parameter has no influence on the tool efficiency. As I already determined the number of doublets to remove during the previous steps, I just have to determine the pK parameter for each sub-dataset.
