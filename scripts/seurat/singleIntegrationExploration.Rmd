...
bindingIsLocked("params", env = .GlobalEnv)
unlockBinding("params", env = .GlobalEnv)
fig.folder <- file.path("/mnt/DATA_4TB/projects/gastruloids_sc_Lescroart/analysis/seuratAnalysis/ciml5", dataset, "figures/")
knitr::opts_chunk$set(
  # code evaluation
  eval = TRUE,
...
SO <- readRDS(paste0("/mnt/DATA_4TB/projects/gastruloids_sc_Lescroart/analysis/seuratAnalysis/ciml5/rdsObjects/03_WF_onSinglets_", dataset, ".rds"))
...
celltypesPred <- read.table(
    paste0("/mnt/DATA_4TB/projects/gastruloids_sc_Lescroart/analysis/seuratAnalysis/ciml5/", dataset, "/cellIdentitiesPredictions_final_", dataset, ".csv"),
    sep = ",", header = TRUE)
```
