...
<!-- write.table(x = markers18vs16, file = paste0("../../../seuratAnalysis/ciml5/lab_day_11/markers_min.pct_logFC_default_", dataset, "_res_1_clusters_16vs18.csv"), sep = ",", row.names = F, col.names = T) -->

<!-- topNmarkers <- extract_topn(markers18vs16, topn = 20) -->

<!-- write.table(x = topNmarkers, file = paste0("../../../seuratAnalysis/ciml5/lab_day_11/top_20_markers_", dataset, "_res_1_clusters_16vs18.csv"), sep = ",", row.names = F, col.names = T) -->
