...
write.table(x = markersCadio, file = paste0("/mnt/DATA_4TB/projects/gastruloids_sc_Lescroart/analysis/seuratAnalysis/ciml5/lab_day_11/markers_min.pct_logFC_default_", dataset, "_res_1_cardioMandClusters.6-8-9.csv"), sep = ",", row.names = F, col.names = T)

topNmarkers <- extract_topn(markersCadio, topn = 20)

write.table(x = topNmarkers, file = paste0("/mnt/DATA_4TB/projects/gastruloids_sc_Lescroart/analysis/seuratAnalysis/ciml5/lab_day_11/top_20_markers_", dataset, "_res_1_cardioMandClusters.6-8-9.csv"), sep = ",", row.names = F, col.names = T)
