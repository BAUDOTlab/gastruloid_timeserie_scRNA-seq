...
### Celltype annotation concistency on all data {.tabset .tabset-pills .tabset-fade}
...
```{r celltype-heatmap-concistency}
# Celltype annotation moves
createHeatmapAnn(SO, day = "Day_04")
```
...
```{r celltype-heatmap-concistency}
# Celltype annotation moves
createHeatmapAnn(SO, day = "Day_05")
```
...
```{r celltype-heatmap-concistency}
# Celltype annotation moves
createHeatmapAnn(SO, day = "Day_06")
```
...
```{r celltype-heatmap-concistency}
# Celltype annotation moves
createHeatmapAnn(SO, day = "Day_11")
```
