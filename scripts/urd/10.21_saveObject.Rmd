---
title: "URD: parameter optimization"
...
attach(params)
PATH_FIGURES <- paste0("/mnt/DATA_4TB/projects/gastruloids_sc_Lescroart/analysis/trajectory/ciml5/paramOptim/figures/sub.", sub,
                       "_knn.", knn,
                       "_sigma.", sigma,
...
```{r save1}
saveRDS(object,
        file="/mnt/DATA_4TB/projects/gastruloids_sc_Lescroart/analysis/trajectory/ciml5/paramOptim/trimmedObject.rds"
)
```
...
colors.use <- rainbow(length(unique(object@group.ids$tip.clusters)))
plotDimArray(object = object,
             reduction.use = "dm",
             dims.to.plot = 1:18,
             label="tip.clusters",
